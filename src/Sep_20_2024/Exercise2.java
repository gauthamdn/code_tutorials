...
public class Exercise2 {
    ...
    public static int max_profits(){
        ...
        for(i=0;i<stock_price.length;i++){
            ...
            if(recommended_sell_day>0){
                i=recommended_sell_day+1;
            }
            ...
            for(j=i+1;j<stock_price.length;j++){
                ...
                if(temp_profit>original_profit){
                   ...
                   // System.out.println("recommended_buy_day "+recommended_buy_day+" at price "+buy_price+" recommended_sell_day  "+recommended_sell_day+" at price "+sell_price);
